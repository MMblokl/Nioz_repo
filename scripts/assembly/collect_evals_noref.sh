...
do
  ...
  echo "Tool,Genome_fraction,Duplication_ratio,Misasseblies,mismatch_per_100kb,NGA50" > quast_evals/${sample}_noref.csv
  for toolpath in ${dir}*/quast_outp_noref/summary/TSV;
  do
