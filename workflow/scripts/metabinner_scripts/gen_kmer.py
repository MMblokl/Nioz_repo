...
#This is a script taken from MetaBinner which generates a kmer profile.
#The version of the script that was included hada bug in its output so this
# was fixed.

#MetaBinner github: https://github.com/ziyewang/MetaBinner
...
if __name__=="__main__":
    ...
    output = sys.argv[4]
    generate_features_from_fasta(fasta_file,length_threshold,kmer_len,output)
