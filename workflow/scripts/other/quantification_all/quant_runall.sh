...
do
  ...
  bash salmon_quant.sh ${id} $1/bbmap/${id}/contigs_filtered.fasta $1/samples/${id}/rawdata/fw.fastq $1/samples/${id}/rawdata/rv.fastq $1/quant_all_methods/salmon/
  ...
  python3 seperate_binreads.py ${id} $1/bbmap/${id}/${id}_sorted.bam $1/filtered_bins/${id} $1/quant_all_methods/${id} $1/quant_all_methods/${id}/unbinned.txt $1/quant_all_methods/${id}/contig_depth.txt
  ...
  #python3 quant_check.py $1/quant_all_methods/${id}/quant_table.txt PATH_TO_ABUNDANCE_DIR_GOES_HERE/${id}.csv $1/gtdbtk/${id}/classification.tsv $1/quant_all_methods/${id}/
